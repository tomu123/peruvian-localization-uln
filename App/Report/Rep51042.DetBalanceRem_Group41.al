report 51042 "Det.Balance Rem.(Group 41)"
{
    ...
    begin
        ...
        calaÒo := DATE2DMY(fechaing, 3);
        IF calaÒo MOD 4 = 0 THEN
            refmes := 29
        ELSE
            refmes := 28;
        CASE calmes OF
            1:
                EXIT('31/' + FORMAT(calmes) + '/' + FORMAT(calaÒo));
            2:
                EXIT(FORMAT(refmes) + '/' + FORMAT(calmes) + '/' + FORMAT(calaÒo));
            3:
                EXIT('31/' + FORMAT(calmes) + '/' + FORMAT(calaÒo));
            4:
                EXIT('30/' + FORMAT(calmes) + '/' + FORMAT(calaÒo));
            5:
                EXIT('31/' + FORMAT(calmes) + '/' + FORMAT(calaÒo));
            6:
                EXIT('30/' + FORMAT(calmes) + '/' + FORMAT(calaÒo));
