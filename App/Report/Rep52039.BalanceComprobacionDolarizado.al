report 52039 "BALANCE DE COMPROBACION DOLAR"
{
    //LIBRO 3.17
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './App/Report/RDLC/BALANCE DE COMPROBACION DOLARIZADO.rdl';
    Caption = 'BALANCE DE COMPROBACION DOLARIZADO', Comment = 'ESM="BALANCE DE COMPROBACION DOLARIZADO"';
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                //     gdinicial := lclGLAccount."Add.-Currency Balance at Date";
                // end;
                // lclGLAccount.Reset();
                // lclGLAccount.SetRange("No.", "G/L Account"."No.");
                ...
                // if lclGLAccount.FindSet() then begin
                //     lclGLAccount.CalcFields("Add.-Currency Balance at Date");
                //     gdfinal := lclGLAccount."Add.-Currency Balance at Date";
                // end;

                // SETRANGE("G/L Account"."Date Filter", DMY2DATE(1, 1, DATE2DMY(StartDate, 3)), CALCDATE('<-1D>', StartDate));

                // CALCFIELDS("G/L Account"."Add.-Currency Debit Amount", "G/L Account"."Add.-Currency Credit Amount");
                // gimporte := ("G/L Account"."Add.-Currency Debit Amount" - "G/L Account"."Add.-Currency Credit Amount") + (gdinicial - gdfinal);
                ...
                CALCFIELDS("G/L Account"."Add.-Currency Debit Amount", "G/L Account"."Add.-Currency Credit Amount");
                gimporte := ("G/L Account"."Add.-Currency Debit Amount" - "G/L Account"."Add.-Currency Credit Amount");
    ...
    begin
        ...
        IF lclRecGLEntry.FINDSET THEN
            REPEAT
                lclAmount += lclRecGLEntry."Additional-Currency Amount";
    ...
    begin
        ...
        IF lclRecGLEntry.FINDSET THEN
            REPEAT
                DebeSaldoPeriodo += lclRecGLEntry."Add.-Currency Debit Amount";
                HaberSaldoPeriodo += lclRecGLEntry."Add.-Currency Credit Amount";
            UNTIL lclRecGLEntry.NEXT = 0;
    end;
}
