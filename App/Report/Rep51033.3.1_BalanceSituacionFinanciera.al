report 51033 "Balance Situacion Financiera"
{
    //LIBRO 3.1
    ...
    ApplicationArea = All;
    RDLCLayout = './App/Report/RDLC/Balance Situacion Financiera.rdl';
    Caption = 'Balance Situacion Financiera', Comment = 'ESM="Estructura de Cuentas"';
        ...
        dataitem(AccScheduleName; "Acc. Schedule Name")
        {
            ...
            dataitem(Heading; Integer)
            {
                ...
                dataitem(AccSchedLineSpec; "Acc. Schedule Line")
                {
                    ...
                    column(CodRubroEstFinSunat_; AccSchedLineSpec."Cod Financial Status")
                    {
                    }
                    column(bNegrita2; gbNEgrita2)
                    {
                    }
                    ...
                    begin
                        ...
                        gbNEgrita2 := FALSE;
                        IF "Acc. Schedule Line".Description = 'ACTIVOS' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = 'ACTIVO CORRIENTE' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = '          TOTAL ACTIVO CORRIENTE' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = 'ACTIVO NO CORRIENTE' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = '          TOTAL ACTIVO NO CORRIENTE' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = '    TOTAL DE ACTIVO' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = 'PASIVOS Y PATRIMONIOS' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = 'PASIVO CORRIENTE' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = '          TOTAL PASIVO CORRIENTE' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = 'PASIVO NO CORRIENTE' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = '          TOTAL PASIVO NO CORRIENTE' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = '    TOTAL PASIVO' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = 'PATRIMONIO NETO' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = '          TOTAL PATRIMONIO NETO' THEN
                            gbNEgrita2 := TRUE;
                        IF "Acc. Schedule Line".Description = ' TOTAL PASIVO Y PATRIMONIO NETO' THEN
                            gbNEgrita2 := TRUE;
                    end;
                    ...
                    begin
                        ...
                        SETCURRENTKEY("Cod Financial Status");
                        SETASCENDING("Cod Financial Status", TRUE);
                    end;
                }
                ...
                dataitem("Acc. Schedule Line"; "Acc. Schedule Line")
                {
                    ...
                    column(CodRubroEstFinSunat; "Acc. Schedule Line"."Cod Financial Status")
                    {
                    }
                    column(bNegrita; gbNegrita)
                    {
                    }
            ...
            begin
                ...
                SETRANGE(Name, '301');
                // SETRANGE("Analysis View Name", '301');
            end;
        }
    }
    ...
    requestpage
    {
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    group(Layout)
                    {
                        ...
                        {
                            Caption = 'Filtro Fecha', Comment = 'ESM="Filtro fecha"';
        ...
        begin
            AccSchedName := '301'; //BG
            ColumnLayoutName := 'SALDO-A';//'SAL-FECH';
        end;
    ...
    var
        ...
        gCuAccountingPeriodMgt: Codeunit "Accounting Period Mgt.";
    ...
    begin
        ...
        //FiscalStartDate := gCuAccountingPeriodMgt.FindFiscalYear(EndDate);
