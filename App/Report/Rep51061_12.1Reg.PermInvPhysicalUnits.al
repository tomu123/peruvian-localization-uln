report 51061 "Reg.Perm. Inv.Physical Units"
{
    //LIBRO 12.1
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './App/Report/RDLC/Reg.Perm. Inv.Physical Units.rdl';
    Caption = 'Reg.Perm. Inv.Physical Units', Comment = 'ESM="Registro Inv. Perm. Und Fis"';
    ...
    dataset
    {
        dataitem("Item Ledger Entry"; "Item Ledger Entry")
        {
            ...
            column(sumCantidadEntrada; sumCantidadEntrada)
            {
            }
            column(sumCantidadSalida; sumCantidadSalida)
            {
            }
            ...
            begin
                ...
                IF gInicial <> 0 THEN
                    cantidadCostInicial := ROUND(gInicialAmt / gInicial, 0.01);
                ...
                IF "Posting Date" >= fechaIni THEN BEGIN
                        ...
                        CASE gValueEntry."Document Type" OF
                            gValueEntry."Document Type"::"Purchase Credit Memo":
                                BEGIN
                                    ...
                                    IF gPurchCrMemoHdr.FINDSET THEN BEGIN
                                        IF (gPurchCrMemoHdr."Legal Document" <> '') THEN
                            ...
                            gValueEntry."Document Type"::"Purchase Invoice":
                                BEGIN
                                    ...
                                    IF gPurchInvHeader.FINDSET THEN BEGIN
                                        IF (gPurchInvHeader."Legal Document" <> '') THEN
                            ...
                            gValueEntry."Document Type"::"Sales Credit Memo":
                                BEGIN
                                    ...
                                    END;
                                    IF (gSalesCrMemoHeader."Legal Document" <> '') THEN
                                        tipoDocumente := gSalesCrMemoHeader."Legal Document";
                                END;
                            gValueEntry."Document Type"::"Sales Invoice":
                                BEGIN
                                    ...
                                    END;
                                    IF (gSalesInvoiceHeader."Legal Document" <> '') THEN
                                        tipoDocumente := gSalesInvoiceHeader."Legal Document";
                                END;
                        END;
                    END ELSE
                    ...
                    IF NOT gRevertido THEN BEGIN
                        IF "Item Ledger Entry".Correction THEN
                    ...
                    IF "Item Ledger Entry".Quantity > 0 THEN BEGIN
                        ...
                        sumCantidadEntrada := sumCantidadEntrada + "Item Ledger Entry".Quantity;
                    ...
                    END ELSE BEGIN
                        ...
                        sumCantidadSalida := sumCantidadSalida + ABS("Item Ledger Entry".Quantity);
                    ...
                    //SALDO FINALES
                    cantidadCostFinal := 0;
                    CantidadFinal := CantidadFinal + (cantidadSal + cantidadEnt);
            ...
            begin
                ...
                "Item Ledger Entry".SETASCENDING("Item Ledger Entry"."Item No.", TRUE);
            end;
        }
    }
    ...
    var
        ...
        sumCantidadEntrada: Integer;
        sumCantidadSalida: Integer;
