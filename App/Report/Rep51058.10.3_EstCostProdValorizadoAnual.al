report 51058 "Est.Cost.Prod.Valorizado Anual"
{
    //LIBRO 10.3
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './App/Report/RDLC/Est.Cost.Prod.Valorizado Anual.rdl';
    ...
    requestpage
    {
        ...
        layout
        {
            area(content)
            {
                field("Fecha Inicial"; gFechaInicio)
                {
                }
    ...
    trigger OnPreReport()
    begin
        gCuPeru.GenerateCostRecordFormat(gFechaInicio, gFechaFinal, '10.3');
