report 51048 "Flujo Efectivo_f2"
{
    // version ULNLPE.v1
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './App/Report/RDLC/Flujo Efectivo_f2.rdl';
    Caption = 'Flujo Efectivo', Comment = 'ESM="Flujo Efectivo"';
