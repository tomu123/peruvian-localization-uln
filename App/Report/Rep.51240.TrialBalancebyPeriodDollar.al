report 51240 "Trial Balance by Period Dollar"
{
    DefaultLayout = RDLC;
    RDLCLayout = './App/Report/RDLC/TrialBalancebyPeriodDollar.rdlc';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                ColumnValuesAsText[1] := RoundAmount("Additional-Currency Net Change");

                for i := 2 to MaxCount do begin
                    SetRange("Date Filter", StartDate[i - 1], EndDate[i - 1]);
                    CalcFields("Additional-Currency Net Change");
                    ColumnValuesAsText[i] := RoundAmount("Additional-Currency Net Change");
                end;
            end;
